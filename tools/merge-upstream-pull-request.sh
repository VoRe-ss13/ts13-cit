...
readonly BASE_PULL_URL="https://api.github.com/repos/Citadel-Station-13/Citadel-Station-13-RP/pulls"
...
if ! git remote | grep upstream > /dev/null; then
   git remote add upstream https://github.com/Citadel-Station-13/Citadel-Station-13-RP.git
fi
...
#tps://discordapp.com/api/channels/$CHANNELID/messages
